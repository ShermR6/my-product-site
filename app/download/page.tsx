      ...
      <div className="grid-3" style={{ marginTop: 18 }}>
        ...
        <div className="panel-white">
          ...
          <a
            ...
            href="https://github.com/ShermR6/aircraft-tracker-desktop/releases/download/v1.0.8/FinalPingSetup.exe"
          >
        ...
        <div className="panel-white">
          ...
          <a
            className="btn btn-solid"
            style={{ width: "100%", display: "block", textAlign: "center", marginTop: 12 }}
            href="https://github.com/ShermR6/aircraft-tracker-desktop/releases/download/v1.0.8/FinalPingSetup.dmg"
          >
            Download for macOS
          </a>
        </div>
        ...
        <div className="panel" style={{ padding: 20 }}>
          ...
          <div style={{ display: "flex", gap: 32, flexWrap: "wrap", fontSize: 13 }}>
            <div>
              ...
              <div style={{ fontWeight: 700 }}>1.0.8</div>
            </div>
            <div>
